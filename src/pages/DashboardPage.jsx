...
import { PredictionComparisonLine } from "../components/graphs/PredictionComparisonLine";
...
import { CorrelationMatrix } from "../components/graphs/CorrelationsMatrixComponent";
import { AnalyticsChart } from "../components/graphs/AnalyticsChart";
...
export const DashboardPage = () => {
  ...
  const getPredictions = async () => {
    try {
      const res = await axios.get(`${URLAPI}/regresion/model_metrics/prediction_data`);
  ...
  return (
    <div className="grid grid-cols-4 grid-rows-4 gap-4 p-3">
      <div className="col-span-4 flex flex-col items-center border-2 border-black">
        ...
        <PredictionComparisonLine data={prediction} />
      </div>
