...
export const GradientBoostingComponent = () => {
    ...
    const getCorrelations = async () => {
      try {
        const res = await axios.get(`${URLAPI}/gradient_boosting/analysis/correlations`);
    ...
    const getPredictions = async () => {
      try {
        const res = await axios.get(
          `${URLAPI}/gradient_boosting/model_metrics/prediction_data`
        );
    ...
    const getBasicStats = async () => {
      try {
        const res = await axios.get(`${URLAPI}/gradient_boosting/analysis/basic_stats`);
